$(() => {
    ...
    if (e.which == 13) { // enter key
       ...
       if (selected === -1) {
        ...
        // make a move
        destination_coordinate = [Math.floor(highlight/8), highlight%8];
    ...
    function same_team(team) {
        //TODO implement according to the player info
        // for now it only checks if it is white
